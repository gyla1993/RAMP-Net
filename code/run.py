...
parser.add_argument('--use_gpu', action=argparse.BooleanOptionalAction, default=True,
                    help='use GPU when available; pass --no-use_gpu for CPU')
...
if __name__ == '__main__':
    ...
    if args.is_training:
        ...
        setting = 'k{}_{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_ls{}_ft{}_dt{}_lr{}_batch{}_{}_{}_mk{}'.format(
            args.k,
            args.task_name,
            args.model_id,
            args.model,
            ...
            args.learning_rate,
            args.batch_size,
            args.des, args.iitr, args.mask_rate)

        print('>>>>>>>start training : {}>>>>>>>>>>>>>>>>>>>>>>>>>>'.format(setting))
        _, _, val_loss = exp.train(setting)
        print(val_loss)
